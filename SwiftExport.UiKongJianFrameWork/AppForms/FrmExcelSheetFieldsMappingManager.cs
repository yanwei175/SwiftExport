...
using CurrentEntity = SwiftExport.Core.Entities.ExcelSheetFieldsMapping;
using CurrentDto = SwiftExport.AppLayer.DTOs.ExcelSheetFieldsMappingDto;



namespace SwiftExport.UiKongJianFrameWork.AppForms
{
    public partial class FrmExcelSheetFieldsMappingManager : Form
    {
        private readonly IExcelSheetFieldsMappingService _service;
        private readonly IMapper _mapper;
        private BindingList<CurrentDto> BdListAllData;
        private readonly BindingSource BdSource1 = new BindingSource();
        public FrmExcelSheetFieldsMappingManager(IExcelSheetFieldsMappingService service,IMapper mapper)
        {
            ...
            Dgv1.EnableDoubleBuffered()
                ...
                .SetNotNullColumnsColumns(nameof(CurrentDto.生效表),nameof(CurrentDto.源字段), nameof(CurrentDto.目标字段))//设置不能为空列
                .SetUniqueColumns(nameof(CurrentDto.目标字段))//设置唯一列
        ...
        private async void TsBtn_Add_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var cell = Dgv1.Rows[0].Cells[nameof(CurrentDto.生效表)];
            ...
            Dgv1.CurrentCell = Dgv1.Rows[0].Cells[nameof(CurrentDto.生效表)];
